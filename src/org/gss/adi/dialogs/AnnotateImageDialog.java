 ...
 public class AnnotateImageDialog extends JDialog
 {
   ...
   private ArrayList<BufferedImage> imgHistory = new ArrayList();
   ...
   public AnnotateImageDialog(Entrance e)
   {
     ...
     boolean onlyOriginal = false;
     if ((e.getEnhancedImage() != null) && (e.getMaskedImage() != null))
       option = new String[] { "Annotate Original Image", "Annotate Enhanced Image", "Annotate Masked Image" };
     else if (e.getEnhancedImage() != null)
       option = new String[] { "Annotate Original Image", "Annotate Enhance Image" };
     else if (e.getMaskedImage() != null)
       option = new String[] { "Annotate Original Image", "Annotate Masked Image" };
     else
       onlyOriginal = true;
     int imgType = 0;
     if (!onlyOriginal)
       imgType = JOptionPane.showOptionDialog(null, null, null, 0, -1, null, option, Integer.valueOf(0));
     setBounds(100, 100, 678, 642);
     ...
     case 0:
       ...
       break;
     case 1:
       this.label.setImage(this.entrance.getEnhancedImage());
       break;
     case 2:
       this.label.setImage(this.entrance.getMaskedImage());
     }
 
     setAlwaysOnTop(true);
     this.label.setImage(this.label.getZoomedOriginal());
     this.width = this.label.getZoomedOriginal().getWidth();
     this.height = this.label.getZoomedOriginal().getHeight();
     this.color = this.entrance.getColor();
     ...
     BufferedImage img = this.label.getZoomedOriginal();
     Graphics g = img.getGraphics();
     g.drawString("Testin", 0, 0);
/* 181 */     g.dispose();
