...
/*     */   private JDialog me;
/*  55 */   private JSlider slider = new JSlider();
/*  56 */   private ZoomPanLabel label = new ZoomPanLabel(this.slider);
/*     */   private boolean TimeSeries;
/*  60 */   Integer[] x = { Integer.valueOf(0), Integer.valueOf(0) };
/*  61 */   Integer[] y = { Integer.valueOf(0), Integer.valueOf(0) };
/*  62 */   private int moving = -1;
/*     */ 
/*     */   public ManualCalibrationDialog(Entrance e, boolean timeSeries)
/*     */   {
/*  68 */     setModal(true);
/*  69 */     this.me = this;
/*  70 */     this.TimeSeries = timeSeries;
/*  71 */     this.slider.setFont(new Font("SansSerif", 0, 10));
/*  72 */     this.slider.setValue(0);
/*  73 */     this.slider.setBounds(565, 524, 250, 23);
/*  74 */     this.contentPanel.add(this.slider);
/*     */ 
/*  76 */     this.label.setBounds(422, 11, 640, 480);
/*  77 */     this.contentPanel.add(this.label);
/*     */ 
/*  79 */     this.label.getLabel().addMouseListener(new MouseAdapter()
/*     */     {
/*     */       public void mousePressed(MouseEvent e) {
/*  82 */         ManualCalibrationDialog.this.mousePress(e);
/*     */       }
/*     */ 
/*     */       public void mouseReleased(MouseEvent e) {
/*  86 */         ManualCalibrationDialog.this.mouseRelease(e);
/*     */       }
/*     */     });
/*  89 */     this.label.getLabel().addMouseMotionListener(new MouseMotionAdapter()
/*     */     {
/*     */       public void mouseDragged(MouseEvent e) {
/*  92 */         ManualCalibrationDialog.this.mouseDrag(e);
/*     */       }
/*     */     });
/*  96 */     this.slider.addChangeListener(new ChangeListener()
/*     */     {
/*     */       public void stateChanged(ChangeEvent arg0) {
/*  99 */         Integer z = Integer.valueOf(ManualCalibrationDialog.this.slider.getValue());
