 ...
 public class PathPanel extends FocusPanel
 {
   ...
   public PathPanel(BufferedImage image1, BufferedImage image2, BufferedImage image3, int rgb)
   {
     ...
     if (rgb == 2) {
       this.textField_1.setText("NDVI value");
   ...
   public void update1(Integer[] X, Integer[] Y)
   {
     ...
     if (this.three.booleanValue()) {
       threePics();
       int total = 0;
       for (int j = 0; j < this.x.length - 1; j++) {
         total += ColorTools.getLinePixels(new Integer[] { this.x[j], this.x[(j + 1)] }, new Integer[] { this.y[j], this.y[(j + 1)] }).size();
       }
       float scale = 255.0F / total;
       total = 0;
       for (int j = 0; j < this.x.length - 1; j++) {
         ArrayList al = ColorTools.getLinePixels(new Integer[] { this.x[j], this.x[(j + 1)] }, new Integer[] { this.y[j], this.y[(j + 1)] });
         for (int i = 0; i < al.size(); i++) {
           int xVal = Math.round(scale * total);
           Point p = (Point)al.get(i);
           int[] rgb = ColorTools.rgb(this.img1.getRGB(p.x, p.y));
           this.redList1.add(new Point(xVal, 255 - rgb[0]));
           this.greenList1.add(new Point(xVal, 255 - rgb[1]));
           this.blueList1.add(new Point(xVal, 255 - rgb[2]));
           rgb = ColorTools.rgb(this.img2.getRGB(p.x, p.y));
           this.redList2.add(new Point(xVal, 255 - rgb[0]));
           this.greenList2.add(new Point(xVal, 255 - rgb[1]));
           this.blueList2.add(new Point(xVal, 255 - rgb[2]));
           rgb = ColorTools.rgb(this.img3.getRGB(p.x, p.y));
           this.redList3.add(new Point(xVal, 255 - rgb[0]));
           this.greenList3.add(new Point(xVal, 255 - rgb[1]));
           this.blueList3.add(new Point(xVal, 255 - rgb[2]));
           total++;
         }
       }
       draw1(); draw2(); draw3();
   ...
   public void draw1()
   {
     ...
     for (int i = 0; i < this.x.length - 1; i++) {
       al.addAll(ColorTools.getLinePixels(new Integer[] { this.x[i], this.x[(i + 1)] }, new Integer[] { this.y[i], this.y[(i + 1)] }));
     }
     ...
     for (int i = 0; i < size.floatValue(); i++) {
       ...
       if (this.RGB < 2) {
         g.drawLine(p.x, p.y, ((Point)this.redList1.get(i + 1)).x, ((Point)this.redList1.get(i + 1)).y);
         r = Float.valueOf(r.floatValue() + p.y);
         g.setColor(G);
         p = (Point)this.greenList1.get(i);
         g.drawLine(p.x, p.y, ((Point)this.greenList1.get(i + 1)).x, ((Point)this.greenList1.get(i + 1)).y);
         gr = Integer.valueOf(gr.intValue() + p.y);
         g.setColor(B);
         p = (Point)this.blueList1.get(i);
         g.drawLine(p.x, p.y, ((Point)this.blueList1.get(i + 1)).x, ((Point)this.blueList1.get(i + 1)).y);
   ...
   public void draw2()
   {
     ...
     for (int i = 0; i < size.floatValue(); i++) {
       ...
       if (this.RGB < 2) {
         g.drawLine(p.x, p.y, ((Point)this.redList2.get(i + 1)).x, ((Point)this.redList2.get(i + 1)).y);
         r = Float.valueOf(r.floatValue() + p.y);
         g.setColor(G);
         p = (Point)this.greenList2.get(i);
         g.drawLine(p.x, p.y, ((Point)this.greenList2.get(i + 1)).x, ((Point)this.greenList2.get(i + 1)).y);
         gr = Integer.valueOf(gr.intValue() + p.y);
         g.setColor(B);
         p = (Point)this.blueList2.get(i);
         g.drawLine(p.x, p.y, ((Point)this.blueList2.get(i + 1)).x, ((Point)this.blueList2.get(i + 1)).y);
         b = Integer.valueOf(b.intValue() + p.y);
       } else {
   ...
   public void draw3()
   {
     ...
     for (int i = 0; i < size.floatValue(); i++) {
       ...
       if (this.RGB < 2) {
         g.drawLine(p.x, p.y, ((Point)this.redList3.get(i + 1)).x, ((Point)this.redList3.get(i + 1)).y);
         r = Float.valueOf(r.floatValue() + p.y);
         g.setColor(G);
         p = (Point)this.greenList3.get(i);
         g.drawLine(p.x, p.y, ((Point)this.greenList3.get(i + 1)).x, ((Point)this.greenList3.get(i + 1)).y);
         gr = Integer.valueOf(gr.intValue() + p.y);
         g.setColor(B);
         p = (Point)this.blueList3.get(i);
         g.drawLine(p.x, p.y, ((Point)this.blueList3.get(i + 1)).x, ((Point)this.blueList3.get(i + 1)).y);
         b = Integer.valueOf(b.intValue() + p.y);
       } else {
     ...
     if (size.floatValue() == 0.0F) {
       ...
       this.g3.setText(this.df.format(gr.intValue() / size.floatValue()));
       this.b3.setText(this.df.format(b.intValue() / size.floatValue()));
     }
   ...
   private void setup() {
     ...
     this.txtColorIntensitiesAlong.setText("Color Intensities Along Path");
     ...
     this.image1txt.setBounds(348, 51, 70, 15);
     add(this.image1txt);
     ...
     this.r1.setBounds(348, 66, 70, 15);
     add(this.r1);
     ...
     this.g1.setBounds(348, 81, 70, 15);
     add(this.g1);
     ...
     this.b1.setBounds(348, 96, 70, 15);
     add(this.b1);
     ...
     this.image2txt.setBounds(348, 111, 70, 15);
     add(this.image2txt);
     ...
     this.r2.setBounds(348, 126, 70, 15);
     add(this.r2);
     ...
     this.g3.setBounds(348, 201, 70, 15);
     add(this.g3);
     ...
     this.r3.setBounds(348, 186, 70, 15);
     add(this.r3);
     ...
     this.image3txt.setBounds(348, 171, 70, 15);
     add(this.image3txt);
     ...
     this.b2.setBounds(348, 156, 70, 15);
     add(this.b2);
     ...
     this.g2.setBounds(348, 141, 70, 15);
     add(this.g2);
     ...
     this.b3.setBounds(348, 216, 70, 15);
     add(this.b3);
