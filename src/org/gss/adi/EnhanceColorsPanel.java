 ...
 public class EnhanceColorsPanel extends ImagePanel
 {
   ...
   private void comboBoxChange()
   {
     ...
     case 0:
       ...
       break;
     case 1:
       this.label.setZoomedOriginal(ColorEnhances.grayScale((byte)0, this.label.getZoomedOriginal()));
       break;
     case 2:
   ...
   private void setup() {
     ...
     red.add(this.redOff);
     red.add(this.redLimit);
     red.add(this.redStretch);
     ...
     green.add(this.greenOff);
     green.add(this.greenStretch);
     green.add(this.greenLimit);
     ...
     blue.add(this.blueOff);
     blue.add(this.blueStretch);
     blue.add(this.blueLimit);
