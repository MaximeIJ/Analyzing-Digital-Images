  ...
  extends ImagePanel
{
  ...
  private void valueChange()
  {
    ...
    if (tool.equals("Line Tool")) {
      Double d = ColorTools.linearDist(this.x[0].intValue(), this.y[0].intValue(), this.x[1].intValue(), this.y[1].intValue());
  ...
  private void changeTool()
  {
    ...
    this.txtStartPoint.setVisible(false);
    this.startX.setVisible(false);
    this.startY.setVisible(false);
    this.txtEndPoint.setVisible(false);
    ...
    if (!s.equals("Select Measurement Tool"))
    {
      if (s.equals("Pixel Tool")) {
        ...
        this.txtStartPoint.setVisible(true);
        ...
        this.startX.setVisible(true);
        this.startY.setVisible(true);
        this.txtEndPoint.setVisible(true);
  ...
  private void mouseDrag(MouseEvent e)
  {
    ...
    if (this.moving > -1) {
      ...
      this.x[0] = Integer.valueOf(eX);
      this.y[0] = Integer.valueOf(eY);
      this.startX.setValue(this.x[0]);
      this.startY.setValue(this.y[0]);
    } else if (tool.equals("Angle Tool")) {
      switch (this.numPoints) {
      case 0: 
        this.x[0] = Integer.valueOf(eX);
  ...
  private void setPt2(int x, int y)
  {
    try
    {
      this.endX.setValue(Integer.valueOf(x));
      this.endY.setValue(Integer.valueOf(y));
    } catch (Exception localException) {}
  } 
  private void setup() {
    ...
    this.txtStartPoint = new JTextField();
    this.txtStartPoint.setVisible(false);
    this.txtStartPoint.setFont(new Font("SansSerif", 0, 13));
    this.txtStartPoint.setBorder(null);
    this.txtStartPoint.setEditable(false);
    this.txtStartPoint.setOpaque(false);
    this.txtStartPoint.setText("Start Point");
    this.txtStartPoint.setBounds(50, 318, 73, 20);
    add(this.txtStartPoint);
    this.txtStartPoint.setColumns(10);
    ...
    this.txtEndPoint.setVisible(false);
    this.txtEndPoint.setFont(new Font("SansSerif", 0, 13));
    this.txtEndPoint.setText("End Point");
    this.txtEndPoint.setOpaque(false);
    this.txtEndPoint.setEditable(false);
    this.txtEndPoint.setColumns(10);
    this.txtEndPoint.setBorder(null);
    this.txtEndPoint.setBounds(50, 357, 73, 20);
    add(this.txtEndPoint);
    ...
    this.redIntens.setBounds(145, 473, 36, 20);
    add(this.redIntens);
    ...
    this.greenIntens.setBounds(145, 489, 36, 20);
    ...
    this.blueIntens.setBounds(145, 505, 36, 20);
    add(this.blueIntens);
    ...
    this.avgIntens.setBounds(145, 522, 36, 20);
    add(this.avgIntens);
    ...
    this.pixNumDesc.setBounds(8, 388, 115, 20);
    add(this.pixNumDesc);
    ...
    this.pixNum.setBounds(143, 388, 70, 20);
    add(this.pixNum);
    ...
    this.lengthArea.setBounds(143, 408, 150, 20);
    add(this.lengthArea);
    ...
    this.txtLengthArea.setBounds(8, 408, 115, 20);
